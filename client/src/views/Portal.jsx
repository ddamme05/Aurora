  ...
  const regenerateQuestion = async (currentQuestionId) => {
    ...
    try {
      const response = await axios.put(
        `/api/openAI/regenerate/${currentQuestionId}`
      );
              ...
              <>
                ...
                <Button
                  ...
                  sx={{
                    ...
                    opacity:
                      score !== null
                        ? 0 === questions[currentQuestionIndex].correctAnswer ||
                          submissions[questions[0].id]
                          ? "1.0"
                          : "0.7"
                        : selectedChoice === 0
                        ? "1.0"
          ...
          <div className="link-ladder">
            {questions.map((link, index) => (
              <a
                ...
                style={{
                  color:
                    submissions[questions[index].id] !== undefined
                      ? "white"
